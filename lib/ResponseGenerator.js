export const getNextResponse = ({ scenario, depth, response, digitEvent }) => {
    ...
    console.log("scenario, dpeth", scenario, depth, response, digitEvent)
...
const nextResponseMap = {
  error: function () {
    const randomVideo = selectRandom([
      "/digi_videos/errors/error1.webm",
      "/digi_videos/errors/error2.webm",
      "/digi_videos/errors/error3.webm",
    ]);
