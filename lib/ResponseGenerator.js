...
const nextResponseMap = {
  ...
  symptom: {
    1: {
        ...
        skinCut: {
            speech: "Apply antibiotic ointments (Bacitracin, Polysporin, Neosporin) to prevent infection. Cover the wound with a bandage to keep out harmful bacteria and dirt. Change the bandage 3 times a day and monitor for signs of infection.",
            nextScenario: "start",
            nextDepth: 0,
    ...
    2.2: {
        ...
        high: {
            speech: "I recommend visiting a doctor near by as soon as possible. In the meantime, take ibuprofen, naproxen, or acetaminophen to reduce pain", 
            nextScenario: "start",
            nextDepth: 0,
  ...
  drugInfo: {
    1: {
      advil: {
        ...
        nextChoices: ["Daily Dose Limit", "General Information", "Interactions"],
      },
      allegra: {
        speech: "Of course. What information specifically do you want to know?",
        nextScenario: "drugInfo",
    ...
    2.1: {
      dosage: {
        speech: "It is recommended that you intake 1 tablet every 4-6 hours. If symptoms persist, 2 may be used. Do not exceed 6 tablets in 24 hours unless directed by a doctor.",
        nextScenario: "start",
        nextDepth: 2.1,
      ...
      interaction: {
        speech: "Advil should not be taken with any other product containing: Ibuprofen (like Motrin), Naproxen (like Aleve or Midol), Aspirin, and Diclofenac",
        nextScenario: "start",
        nextDepth: 2.1,
    ...
    2.2: {
      dosage: {
        speech: "This product is for adults and children 12 years of age and over. You should take one 180 mg tablet with water once a day; do not take more than 1 tablet in 24 hours.",
        nextScenario: "start",
        nextDepth: 2.1,
      ...
      interaction: {
        speech: "Allegra should not be taken at the same time as aluminum or magnesium antacids. In addition, do not take with fruit juices",
        nextScenario: "start",
        nextDepth: 2.1,
