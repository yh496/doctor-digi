...
const nextResponseMap = {
  ...
  symptom: {
    ...
    2.1: {
      ...
      high: {
        speech:
          "Based on your current symptoms, we recommend you to take acetaminophen and ibuprofen. One popular OTC medicine for acetaminophen is Tylenol. One popular OTC medicine for ibuprofen is Advil.",
        nextScenario: "start",
        nextDepth: 0,
